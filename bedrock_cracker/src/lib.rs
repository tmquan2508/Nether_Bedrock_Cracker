...
#[no_mangle]
pub extern "C" fn estimate_result_amount(blocks_ptr: *const Block, len: usize) -> u64 {
...
#[no_mangle]
pub extern "C" fn crack(blocks_ptr: *const Block, len: usize, threads: u64, mode: BedrockGeneration, output_mode: OutputMode) -> VecI64 {
    let blocks: &[Block] = unsafe {
        std::slice::from_raw_parts(blocks_ptr, len)
    };
